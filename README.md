...
### Модуль `src/views.py`
Функции для записи данных в JSON-файл.
...
2. Функция `save_report` — декоратор для функций-отчётов, который записывает в файл результат, возвращаемый функциям, формирующими отчёты.
